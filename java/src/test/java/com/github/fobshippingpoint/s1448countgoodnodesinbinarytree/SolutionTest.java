...
public class SolutionTest {
    ...
    public static Stream<Arguments> provider() {
        return Stream.of(
                Arguments.of("Should return 4 for root = [3,1,4,3,null,1,5]",
                        new Integer[]{3, 1, 4, 3, null, 1, 5}, 4),
                Arguments.of("Should return 3 for root = [3,3,null,4,2]",
                        new Integer[]{3, 3, null, 4, 2}, 3),
    ...
    public void testGoodNodesV1(String message, Integer[] root, int expect) {
        var result = solution.goodNodes(arrayToTree(root));
